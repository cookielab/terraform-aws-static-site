...
output "deploy_role_name" {
  description = "IAM Role name of the deploy role"
  value       = var.enable_deploy_role ? module.deploy_identity.deploy_role_name : null
}

output "deploy_instance_profile_name" {
  description = "Instance profile name with the deploy role attached"
  value       = var.create_instance_profile ? module.deploy_identity.deploy_instance_profile : null
}
