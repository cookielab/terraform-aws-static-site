...
| <a name="input_extra_gitlab_cicd_variables"></a> [extra\_gitlab\_cicd\_variables](#input\_extra\_gitlab\_cicd\_variables) | List of additional gitlab CI/CD variables | <pre>list(object({<br/>    key               = string<br/>    value             = string<br/>    protected         = optional(bool, false)<br/>    masked            = optional(bool, false)<br/>    hidden            = optional(bool, false)<br/>    raw               = optional(bool, true)<br/>    environment_scope = optional(string, "*")<br/>  }))</pre> | `[]` | no |
