...
| Name | Source | Version |
| ---- | ------ | ------- |
| <a name="module_cdn"></a> [cdn](#module\_cdn) | terraform-aws-modules/cloudfront/aws | 6.6.0 |
...
| [aws_iam_policy_document.kms_cloudfront_policy](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
...
| <a name="input_extra_gitlab_cicd_variables"></a> [extra\_gitlab\_cicd\_variables](#input\_extra\_gitlab\_cicd\_variables) | List of additional gitlab CI/CD variables | <pre>list(object({<br/>    key               = string<br/>    value             = string<br/>    protected         = optional(bool, false)<br/>    masked            = optional(bool, false)<br/>    hidden            = optional(bool, false)<br/>    raw               = optional(bool, true)<br/>    environment_scope = optional(string, "*")<br/>    variable_type     = optional(string, "env_var")<br/>    description       = optional(string, "")<br/>  }))</pre> | `[]` | no |
...
| <a name="output_deploy_instance_profile_name"></a> [deploy\_instance\_profile\_name](#output\_deploy\_instance\_profile\_name) | Instance profile name with the deploy role attached |
| <a name="output_deploy_role_arn"></a> [deploy\_role\_arn](#output\_deploy\_role\_arn) | IAM Role ARN of the deploy role |
| <a name="output_deploy_role_name"></a> [deploy\_role\_name](#output\_deploy\_role\_name) | n/a |
| <a name="output_moved_blocks"></a> [moved\_blocks](#output\_moved\_blocks) | Generated moved blocks for the `gitlab_project_variables`, `aws_route53_record` and `aws_kms_alias` |
