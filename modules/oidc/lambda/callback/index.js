...
exports.handler = (event, context, callback) => {
  ...
  // API Gateway payload 2.0 formát
    ...
    res.on('end', () => {
      try {
        ...
        const signature = crypto
          ...
          .update(sessionValue)
          .digest('hex');
        const sessionCookie = `session=${sessionValue}.${signature}; Domain=staging-fridges-list.jidlomat.dev; Path=/; HttpOnly; Secure; SameSite=None; Max-Age=3600`;
